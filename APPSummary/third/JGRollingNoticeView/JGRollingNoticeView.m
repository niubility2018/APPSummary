...
@interface JGRollingNoticeView ()

@property (nonatomic, strong) NSMutableDictionary *cellClsDict;
@property (nonatomic, strong) NSMutableArray *reuseCells;

@property (nonatomic, assign) int currentIndex;
@property (nonatomic, strong) JGNoticeViewCell *currentCell;
@property (nonatomic, strong) JGNoticeViewCell *willShowCell;
@property (nonatomic, strong) UITapGestureRecognizer *JGTapGesture;

@end

@implementation JGRollingNoticeView
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _stayInterval = 2;
        [self addGestureRecognizer:self.JGTapGesture];
    }
    return self;
}
...
{
    for (JGNoticeViewCell *cell in self.reuseCells) {
...
- (UITapGestureRecognizer *)JGTapGesture
{
    if (nil == _JGTapGesture) {
        _JGTapGesture = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(handleCellTapAction)];
    }
    return _JGTapGesture;
}
