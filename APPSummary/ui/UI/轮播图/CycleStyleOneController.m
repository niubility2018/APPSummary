...
#import "BLBView.h"
@interface CycleStyleOneController ()<UIScrollViewDelegate>
@property(nonatomic, strong)BLBView *bannerView;

@end

@implementation CycleStyleOneController
...
- (void)viewDidLoad {
    ...
    view.frame = CGRectMake(0, kNavigationBarHeight, screen_width, [BLBView myHeight]);
