...
- (void)viewDidLoad {
    ...
    self.dataUIArray = @[@"启动引导页动画",@"标签云",@"人脸识别",@"image处理",@"倒计时",@"画板",@"wifi认证",@"指纹识别",@"QQ临时会话",@"弹出视图",@"音乐",@"图表库",@"钟表",@"计步器",@"滚动公告",@"仿唱吧下载",@"弹簧效果",@"转动",@"屏幕截图",@"YYText文字处理",@"动画",@"tableViewCell动画",@"文字动画",@"拆红包动画",@"祝福动画",@"仿转转"];
