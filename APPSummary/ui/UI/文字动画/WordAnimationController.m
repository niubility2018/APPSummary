...
@interface WordAnimationController ()<UIActionSheetDelegate>

@end

@implementation WordAnimationController
...
- (void)viewDidLoad {
    ...
    self.label = [[ZCAnimatedLabel alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(self.debugRedraw.frame) + 15, screen_width - 30, screen_height - CGRectGetMaxY(self.debugRedraw.frame))];
